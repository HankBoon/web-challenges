...
function findByLastName(employees, lastName) {
  // const employeesLowerCase = employees.map((employee) => {
  //   return employee.toLowerCase;
  // });
  // check if employees contains an item with a key lastName equal to query lastName
  // return the item(which is an object)
  ...
  //second approach
  console.log(employees.find((employee) => employee.lastName === lastName));
  return employees.find((employee) => employee.lastName === lastName);

  // third approach
  // console.log(employees.filter((employee) => employee.lastName === lastName));
  // const result = employees.filter((employee) => employee.lastName === lastName);
  // return
}
...
function findByCitySubString(employees, string) {
  if (employees.some((employee) => employee.city.includes(string))) {
  }
}
...
function findByProfessionSubStringAndAge(employees, string, age) {
  return employees.find(
    (employee) => employee.age > age && employee.profession.includes(string)
  );
}
