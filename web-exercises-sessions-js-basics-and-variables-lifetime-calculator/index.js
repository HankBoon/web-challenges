...
const daysToLive = (80 - currentAge) * 365;
const percentageLived = currentAge / (80 / 100);
const sleptDays = currentAge * 365 * 8;

console.log("Your current age is: " + currentAge);
console.log("You have " + daysToLive + " days to live.");
console.log(
  "You have already lived " + percentageLived + " percentage of your life."
);
console.log(
  "You have already slept " + sleptDays + " days in your whole life."
);
