...
function maxOfTwoNumbers(num1, num2) {
  // TODO:
  // compare them to each other with an if statement
  // if bigger return this variable , else return second value.
  if (num1 > num2) {
    return num1;
  } else {
    return num2;
...
function sumNumbers(numbers) {
  ...
  // use a forEach loop to add eeach value to sum
  // return sum
  let sum = 0;
...
function averageWordLength(words) {
  // TODO:
  //declare a variable averageLength
  //use a forEach loop on every array item and add it to averagelength.
  //divide avergelength by a number which equals the idex of the item plus 1.
  // return sum
...
function uniquifyArray(words) {
  // TODO:
  // declare a new array
  // use map on every array item
  // inside map use if statement to check if item already exists in new array
  //
  // const newArray = [];
  // newArray = words3.map((item) => {
